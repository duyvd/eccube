...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.request_matcher.wqxqnfy' => 'getSecurity_RequestMatcher_WqxqnfyService.php',
            ...
            'service_locator.8lji7yh' => 'getServiceLocator_8lji7yhService.php',
            ...
            'service_locator.c2avtcj' => 'getServiceLocator_C2avtcjService.php',
            ...
            'service_locator.o3hzvyi' => 'getServiceLocator_O3hzvyiService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.wqxqnfy' => true,
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.wqxqnfy']) ? $this->services['security.request_matcher.wqxqnfy'] : ($this->services['security.request_matcher.wqxqnfy'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
    ...
    {
        return $this->services['session.handler'] = new \Eccube\Session\Storage\Handler\SameSiteNoneCompatSessionHandler(new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[3].'/var/sessions/prod')));
    }
