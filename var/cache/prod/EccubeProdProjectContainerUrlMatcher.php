...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/nikken_admin')) {
            // admin_login
            ...
            elseif (0 === strpos($pathinfo, '/nikken_admin/product')) {
                ...
                elseif (0 === strpos($pathinfo, '/nikken_admin/product/tag')) {
                    // admin_product_tag
                ...
                if ('/nikken_admin/product' === $pathinfo) {
                    $ret = array (  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::index',  '_route' => 'admin_product',);
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/nikken_admin/product/page') && preg_match('#^/nikken_admin/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_page']), array (  'page_no' => NULL,  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::index',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/nikken_admin/product/product')) {
                    ...
                    if ('/nikken_admin/product/product/image/add' === $pathinfo) {
                        $ret = array (  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::addImage',  '_route' => 'admin_product_image_add',);
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, ['POST'])) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/nikken_admin/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_product_delete']), array (  'id' => NULL,  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, ['DELETE'])) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/nikken_admin/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_product_copy']), array (  'id' => NULL,  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::copy',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, ['POST'])) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/nikken_admin/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_product_display']), array (  'id' => NULL,  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::display',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/nikken_admin/product/classes') && preg_match('#^/nikken_admin/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_classes_load']), array (  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::loadProductClasses',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($canonicalMethod, ['GET'])) {
                        if ($hasRequiredScheme) {
                ...
                if ('/nikken_admin/product/export' === $pathinfo) {
                    $ret = array (  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::export',  '_route' => 'admin_product_export',);
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/nikken_admin/product/bulk/product-status') && preg_match('#^/nikken_admin/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_bulk_product_status']), array (  '_controller' => 'Customize\\Controller\\Admin\\CustomProductController::bulkProductStatus',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($requestMethod, ['POST'])) {
                        if ($hasRequiredScheme) {
