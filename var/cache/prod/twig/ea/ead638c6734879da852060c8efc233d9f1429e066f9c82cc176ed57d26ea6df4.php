...
class __TwigTemplate_01525dfc8478bb8ebb8dd12dffde10232060884c55872d0f3c2268bb4d0205b0 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
<table border=\"0\" width=\"100%\" height=\"100%\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#F0F0F0\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
    <tr>
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["Order"] ?? null), "complete_mail_message", [], "any", false, false, false, 119))) {
            // line 120
            echo "                                ";
            echo nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Order"] ?? null), "complete_mail_message", [], "any", false, false, false, 120), "html", null, true));
            echo "<br/>
                            ";
        }
        // line 122
...
";
    ...
    {
        return new Source("", "Mail\\order.html.twig", "C:\\xampp\\htdocs\\eccube\\src\\Eccube\\Resource\\template\\default\\Mail\\order.html.twig");
    }
}
