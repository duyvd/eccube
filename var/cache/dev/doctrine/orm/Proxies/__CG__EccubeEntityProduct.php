...
class Product extends \Eccube\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['material' => NULL, 'outer_size' => NULL, 'inner_size' => NULL, 'self_weight' => NULL, 'load_weight' => NULL];
    ...
    {
        unset($this->material, $this->outer_size, $this->inner_size, $this->self_weight, $this->load_weight);
