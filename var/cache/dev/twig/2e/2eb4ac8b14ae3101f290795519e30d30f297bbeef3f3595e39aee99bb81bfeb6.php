...
class __TwigTemplate_f99c40098f42d54806655c74a1265afc05f7d090a9302b6833825cf29e9a1c96 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 28, $this->source); })()), "totalItemCount", [], "any", false, false, false, 28) > 0)) {
            ...
            echo "                    <div class=\"ec-favoriteRole__header\">
                        <p>";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("%count%件のお気に入りがあります", ["%count%" => twig_get_attribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 30, $this->source); })()), "totalItemCount", [], "any", false, false, false, 30)]), "html", null, true);
            echo "</p>
                    </div>
...
{% endblock %}
", "Mypage\\favorite.twig", "C:\\xampp\\htdocs\\eccube\\src\\Eccube\\Resource\\template\\default\\Mypage\\favorite.twig");
    }
}
