...
/* Forgot\index.twig */
class __TwigTemplate_e245e4b1784fd28a52d56d81282d9d4c5a35dccaa20df6fef6ffec1f77cc637c extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
                        ...
                        <div class=\"ec-borderedDefs\">
                            <dl>
                                <dt>
                                    ";
        // line 34
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 34, $this->source); })()), "login_email", [], "any", false, false, false, 34), 'label', ["label_attr" => ["class" => "ec-label"], "label" => "メールアドレス"]);
        echo "
                                </dt>
                                <dd>
                                    <div class=\"ec-input";
...
", "Forgot\\index.twig", "C:\\xampp\\htdocs\\eccube\\src\\Eccube\\Resource\\template\\default\\Forgot\\index.twig");
    }
}
