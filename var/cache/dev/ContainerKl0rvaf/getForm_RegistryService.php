...
}, 8), 'Eccube\\Form\\Type\\Admin\\ProductType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\ProductTypeExtension']) ? $this->services['Customize\\Form\\Extension\\ProductTypeExtension'] : ($this->services['Customize\\Form\\Extension\\ProductTypeExtension'] = new \Customize\Form\Extension\ProductTypeExtension())) && false ?: '_'};
